...
public abstract class AbstractExecutorChooser implements ExecutorChooser {

    protected final SingleThreadExecutor[] executors;
    protected final AtomicInteger idx = new AtomicInteger(0);
    ...
    public SingleThreadExecutor chooseExecutor() {
        return chooseExecutor(idx.getAndIncrement());
    }


    public abstract SingleThreadExecutor chooseExecutor(int index);
}

...
public abstract class RepeatedTimer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RepeatedTimer.class);
    ...
    protected void onDestroy() {
        LOGGER.info(String.format("Destroy timer: %s.", this));
    }
    ...
    /**
     * Restart the timer. It will be started if it's stopped, and it will be
     * restarted if it's running.
     *
    ...
    private void schedule() {
        ...
        final TimerTask timerTask = timeout -> {
            try {
                ...
                LOGGER.error(String.format("Run timer task failed, taskName=%s.", RepeatedTimer.this.name), t);
            }
        };

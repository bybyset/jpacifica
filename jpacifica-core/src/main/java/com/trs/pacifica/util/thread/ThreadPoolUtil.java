...
public final class ThreadPoolUtil {
    ...
    public static class PoolBuilder {
        ...
        public ThreadPoolExecutor build() {
            Objects.requireNonNull(this.poolName, "poolName");
            Objects.requireNonNull(this.enableMetric, "enableMetric");
            Objects.requireNonNull(this.coreThreads, "coreThreads");
            Objects.requireNonNull(this.maximumThreads, "maximumThreads");
            Objects.requireNonNull(this.keepAliveSeconds, "keepAliveSeconds");
            Objects.requireNonNull(this.workQueue, "workQueue");
